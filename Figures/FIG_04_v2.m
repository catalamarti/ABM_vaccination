...
for ij = 1:length(nam)
    ...
    I1 = Infected./Infected(1,:)-1;
    I2 = Hospital./Hospital(1,:)-1;
    I3 = Deadssss./Deadssss(1,:)-1;
    I4 = Restrict./Restrict(1,:)-1;
    ...
    c3 = [1 0 0];
    N = 1e3;
    [COL1] = matrixcolors(c1,c2,c3,N,lim);
